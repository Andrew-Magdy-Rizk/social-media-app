          ...
          <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 md:px-24 py-12">
            <div className="max-w-110 w-full mx-auto">
              ...
              <div className="flex items-center my-8">
                ...
                <span className="px-4 text-[#617589] text-sm">or continue with</span>
                <div className="flex-1 border-t border-[#dbe0e6] dark:border-white/10" />
              </div>
              {/* Social Logins */}
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-2 h-12 border border-[#dbe0e6] dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors font-semibold text-[#111418] dark:text-white">
                ...
                <button className="flex items-center justify-center gap-2 h-12 border border-[#dbe0e6] dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors font-semibold text-[#111418] dark:text-white">
                  <svg className="w-5 h-5 fill-black dark:fill-white" viewBox="0 0 24 24">
              ...
              <div className="text-center mt-10">
                <p className="text-[#111418] dark:text-white text-base font-normal">
                  ...
                  <Link to={"/register"} className="text-primary font-bold hover:underline decoration-2 underline-offset-4 ml-1">Sign Up</Link>
                </p>
              </div>
            </div>
          </div>
