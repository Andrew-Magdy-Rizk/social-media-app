import { Image, ImagePlay, MapPin, Smile } from "lucide-react";
            ...
            <div className="rounded-xl border border-primary/10 bg-white p-4 shadow-sm">
                <div className="flex gap-2">
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                        <textarea className="w-full resize-none border-none bg-transparent p-0 text-base placeholder:text-[#bac4ce] focus:ring-0 focus:outline-0 " placeholder="What's happening?" rows={2} defaultValue={""} />
                        <div className="flex items-center justify-between border-t border-primary/5 pt-3">
                            <div className="flex gap-2">
                                ...
                                <button className="flex h-9 w-9 items-center justify-center rounded-lg text-[#617589] hover:bg-primary/10 hover:text-primary transition-all">
                                    <span className="material-symbols-outlined text-[20px]"><ImagePlay /></span>
                                </button>
                                <button className="flex h-9 w-9 items-center justify-center rounded-lg text-[#617589] hover:bg-primary/10 hover:text-primary transition-all">
                                    <span className="material-symbols-outlined text-[20px]"><Smile /></span>
                                </button>
                                <button className="flex h-9 w-9 items-center justify-center rounded-lg text-[#617589] hover:bg-primary/10 hover:text-primary transition-all">
                                    <span className="material-symbols-outlined text-[20px]"><MapPin /></span>
                                </button>
                            </div>
